...
SQL_COMMANDS = [
    ...
    ('반소매', 'Short-sleeve Shirt', '의류', '예', '예', '제한 없음', 'manual'),
    ('반바지', 'Shorts', '의류', '예', '예', '제한 없음', 'manual'),
    ('샌들', 'Sandals', '신발', '예', '예', '제한 없음', 'manual'),
    ('얇은 원피스', 'Light Dress', '의류', '예', '예', '제한 없음', 'manual'),
    ...
    ('긴소매 셔츠', 'Long-sleeve Shirt', '의류', '예', '예', '제한 없음', 'manual'),
    ('가디건', 'Cardigan', '의류', '예', '예', '제한 없음', 'manual'),
    ('면바지', 'Cotton Pants', '의류', '예', '예', '제한 없음', 'manual'),
    ('스니커즈', 'Sneakers', '신발', '예', '예', '제한 없음', 'manual'),
    ('스카프', 'Scarf', '패션잡화', '예', '예', '제한 없음', 'manual'),
    ('경량 조끼', 'Lightweight Vest', '의류', '예', '예', '제한 없음', 'manual'),
    ('스웨터', 'Sweater', '의류', '예', '예', '제한 없음', 'manual'),
    ('경량패딩', 'Lightweight Padded Jacket', '의류', '예', '예', '제한 없음', 'manual'),
    ('자켓', 'Jacket', '의류', '예', '예', '제한 없음', 'manual'),
    ('머플러', 'Muffler', '패션잡화', '예', '예', '제한 없음', 'manual'),
    ('두꺼운 외투', 'Heavy Coat', '의류', '예', '예', '제한 없음', 'manual'),
    ('내복', 'Thermal Underwear', '의류', '예', '예', '제한 없음', 'manual'),
    ('목도리', 'Winter Scarf', '패션잡화', '예', '예', '제한 없음', 'manual'),
    ('장갑', 'Gloves', '패션잡화', '예', '예', '제한 없음', 'manual'),
    ('기모 바지', 'Fleece-lined Pants', '의류', '예', '예', '제한 없음', 'manual'),
    ('귀마개/비니', 'Earmuffs/Beanie', '패션잡화', '예', '예', '제한 없음', 'manual'),
    ('기모 안감 의류', 'Fleece-lined Clothing', '의류', '예', '예', '제한 없음', 'manual'),
    ('가벼운 겉옷', 'Light Outerwear', '의류', '예', '예', '제한 없음', 'manual'),
    ('겹쳐 입을 얇은 옷', 'Layering Clothes', '의류', '예', '예', '제한 없음', 'manual'),
    ('3단 우산', 'Folding Umbrella', '기타', '예 (특별 지침)', '예', '끝이 날카롭지 않은 소형 우산은 대부분 가능하나, 장우산 등 일부는 항공사 규정 확인이 필요합니다.', 'manual'),
    ('방수 자켓', 'Waterproof Jacket', '의류', '예', '예', '제한 없음', 'manual'),
    ('방수 신발', 'Waterproof Shoes', '신발', '예', '예', '제한 없음', 'manual'),
    ('여벌 양말', 'Extra Socks', '의류', '예', '예', '제한 없음', 'manual'),
    ('속건성 의류', 'Quick-dry Clothing', '의류', '예', '예', '제한 없음', 'manual'),
    ('작은 수건', 'Small Towel', '위생용품', '예', '예', '제한 없음', 'manual'),
    ('방한/방수 부츠', 'Winter/Waterproof Boots', '신발', '예', '예', '제한 없음', 'manual'),
    ('핫팩', 'Hand Warmer', '기타', '예 (특별 지침)', '예', '일회용 핫팩은 소량 가능하나, 액체형/충전식(리튬배터리)은 규정 확인이 필수입니다.', 'manual'),
    ('방수 장갑', 'Waterproof Gloves', '패션잡화', '예', '예', '제한 없음', 'manual'),
    ('귀마개', 'Earmuffs', '패션잡화', '예', '예', '제한 없음', 'manual'),
    ('넥워머/바라클라바', 'Neck Warmer/Balaclava', '패션잡화', '예', '예', '제한 없음', 'manual'),
    ...
    ('선글라스', 'Sunglasses', '패션잡화', '예', '예', '제한 없음', 'manual'),
    ('모자', 'Hat', '패션잡화', '예', '예', '제한 없음', 'manual'),
    ('립밤 (자외선 차단 기능)', 'SPF Lip Balm', '화장품', '예', '예', '고체형 립밤은 액체류 규정이 적용되지 않습니다.', 'manual'),
    ('얇은 긴팔 셔츠', 'Light Long-sleeve Shirt', '의류', '예', '예', '제한 없음', 'manual'),
    ('바람막이', 'Windbreaker', '의류', '예', '예', '제한 없음', 'manual'),
    ('머리끈', 'Hair Tie', '패션잡화', '예', '예', '제한 없음', 'manual'),
    ('통기성 좋은 옷', 'Breathable Clothing', '의류', '예', '예', '제한 없음', 'manual'),
    ('여벌 속옷', 'Extra Underwear', '의류', '예', '예', '제한 없음', 'manual'),
    ('휴대용 제습제', 'Portable Dehumidifier', '기타', '예 (특별 지침)', '예', '화학물질 포함 여부에 따라 항공사 확인이 필요합니다.', 'manual'),
    ('스포츠 타월', 'Sports Towel', '위생용품', '예', '예', '제한 없음', 'manual'),
    ('여벌 옷', 'Extra Clothes', '의류', '예', '예', '제한 없음', 'manual'),
    ('KF94 등급 이상의 마스크', 'KF94 Mask or higher', '위생용품', '예', '예', '제한 없음', 'manual'),
    ('마스크', 'Mask', '위생용품', '예', '예', '제한 없음', 'manual'),
    ...
    ('이어폰/헤드폰', 'Earphones/Headphones', '전자기기', '예', '예', '제한 없음', 'manual'),
    ...
    ('멀티 포트 충전기', 'Multi-port Charger', '전자기기', '예', '예', '제한 없음', 'manual'),
    ('휴대용 전기포트', 'Travel Electric Kettle', '전자기기', '예', '예', '제한 없음', 'manual'),
    ...
    ('의류용 압축팩', 'Compression Packing Cube', '기타', '예', '예', '제한 없음', 'manual'),
    ...
    ('공용 경비 지갑/파우치', 'Shared Expense Wallet/Pouch', '기타', '예', '예', '제한 없음', 'manual'),
    ('어린이용 상비약', 'Children's First-Aid', '의약품', '예 (특별 지침)', '예', '액체류 해열제 등은 액체류 규정을 따릅니다. 처방약은 영문 처방전을 지참하는 것이 안전합니다.', 'manual'),
    ('미아방지용 이름표/팔찌', 'Anti-lost Name Tag/Bracelet', '기타', '예', '예', '제한 없음', 'manual'),
    ('수영복 / 래시가드', 'Swimsuit/Rash Guard', '의류', '예', '예', '제한 없음', 'manual'),
    ('선크림 / 알로에 젤', 'Sunscreen/Aloe Gel', '화장품', '예 (3.4oz/100 ml 이상 또는 동일)', '예', '100ml 이하 용기에 담아 1L 투명 지퍼백에 보관 시 기내 반입 가능합니다.', 'manual'),
    ('방수팩', 'Waterproof Pouch', '기타', '예', '예', '제한 없음', 'manual'),
    ('책 / E-book 리더기', 'Book/E-book Reader', '기타', '예', '예', '제한 없음', 'manual'),
    ('방수 블루투스 스피커', 'Waterproof Bluetooth Speaker', '전자기기', '예 (특별 지침)', '예', '배터리가 내장되어 있으므로 리튬 배터리 규정을 확인해야 합니다.', 'manual'),
    ('두꺼운 양말 / 실내용 슬리퍼', 'Thick Socks/Indoor Slippers', '의류', '예', '예', '제한 없음', 'manual'),
    ...
    ('가습기(소형)', 'Small Humidifier', '전자기기', '예', '예', '제한 없음', 'manual'),
    ('수면 안대', 'Sleep Mask', '기타', '예', '예', '제한 없음', 'manual'),
    ('등산/트레킹 샌들', 'Hiking/Trekking Sandals', '신발', '예', '예', '제한 없음', 'manual'),
    ...
    ('모자 / 스포츠용 선글라스', 'Hat/Sports Sunglasses', '패션잡화', '예', '예', '제한 없음', 'manual'),
    ('벌레 기피제', 'Insect Repellent', '의약품', '예 (3.4oz/100 ml 이상 또는 동일)', '예', '100ml 이하 용기의 에어로졸/액체류 규정을 따릅니다.', 'manual'),
    ('스포츠용 양말', 'Sports Socks', '의류', '예', '예', '제한 없음', 'manual'),
    ('방수/방한 등산화', 'Waterproof/Winter Hiking Boots', '신발', '예', '예', '제한 없음', 'manual'),
    ('핫팩 / 보온병', 'Hand Warmer/Thermos', '기타', '예 (특별 지침)', '예', '핫팩은 항공사 확인이 필요하며, 보온병은 비운 상태로 통과해야 합니다.', 'manual'),
    ('기능성 내의 (히트텍 등)', 'Functional Underwear (Heattech)', '의류', '예', '예', '제한 없음', 'manual'),
    ('고글 / 바라클라바', 'Goggles/Balaclava', '패션잡화', '예', '예', '제한 없음', 'manual'),
    ('등산용 스패츠', 'Hiking Gaiters', '패션잡화', '예', '예', '제한 없음', 'manual'),
    ('소형 아이젠', 'Microspikes', '기타', '예 (특별 지침)', '예', '날카로운 부분이 있어 일부 항공사는 위탁만 허용할 수 있습니다.', 'manual'),
    ('통기성 좋은 긴팔/긴바지', 'Breathable Long-sleeve/Pants', '의류', '예', '예', '제한 없음', 'manual'),
    ('휴대용 양산 / 접이식 부채', 'Parasol/Folding Fan', '기타', '예', '예', '제한 없음', 'manual'),
    ...
    ('작은 크로스백', 'Small Crossbody Bag', '패션잡화', '예', '예', '제한 없음', 'manual'),
    ('벗기 쉬운 여러 겹의 옷', 'Easy-to-layer Clothes', '의류', '예', '예', '제한 없음', 'manual'),
    ('스마트폰 터치 장갑', 'Smartphone Touch Gloves', '패션잡화', '예', '예', '제한 없음', 'manual'),
    ('따뜻한 스카프/목도리', 'Warm Scarf/Muffler', '패션잡화', '예', '예', '제한 없음', 'manual'),
    ('편하고 스타일 좋은 샌들/스니커즈', 'Comfy & Stylish Sandals/Sneakers', '신발', '예', '예', '제한 없음', 'manual'),
    ('에코백 / 접이식 가방', 'Eco Bag/Foldable Bag', '기타', '예', '예', '제한 없음', 'manual'),
    ('동전 지갑', 'Coin Purse', '기타', '예', '예', '제한 없음', 'manual'),
    ('발 피로 완화 파스 (휴족 시간 등)', 'Foot Relief Patch', '의약품', '예 (특별 지침)', '예', '일반의약품 규정을 따릅니다.', 'manual'),
    ('따뜻하고 걷기 편한 부츠', 'Warm & Comfy Boots', '신발', '예', '예', '제한 없음', 'manual'),
    ('장갑 / 모자 / 귀마개', 'Gloves/Hat/Earmuffs', '패션잡화', '예', '예', '제한 없음', 'manual'),
    ('어깨에 걸치는 숄/판초', 'Shawl/Poncho', '의류', '예', '예', '제한 없음', 'manual'),
    ...
    ('휴대용 보냉백', 'Portable Cooler Bag', '기타', '예', '예', '제한 없음', 'manual'),
    ('소화제', 'Digestive Aid', '의약품', '예 (특별 지침)', '예', '일반의약품 규정을 따릅니다.', 'manual'),
    ('헐렁한 바지 (고무줄 바지)', 'Loose-fitting Pants', '의류', '예', '예', '제한 없음', 'manual'),
    ('구강청결제', 'Mouthwash', '위생용품', '예 (3.4oz/100 ml 이상 또는 동일)', '예', '100ml 이하 용기에 담아 1L 투명 지퍼백에 보관 시 기내 반입 가능합니다.', 'manual'),
    ('목베개', 'Neck Pillow', '기타', '예', '예', '제한 없음', 'manual'),
    ('안대 및 귀마개', 'Eye Mask & Earplugs', '기타', '예', '예', '제한 없음', 'manual'),
    ('편한 슬리퍼 / 두꺼운 양말', 'Slippers/Thick Socks', '의류', '예', '예', '제한 없음', 'manual'),
    ...
    ('소음 차단 헤드폰/이어폰', 'Noise-cancelling Headphones/Earphones', '전자기기', '예', '예', '제한 없음', 'manual'),
    ('태블릿PC / E-book (콘텐츠 저장)', 'Tablet/E-book (with downloaded content)', '전자기기', '예', '예', '제한 없음', 'manual'),
    ('현지 긴급 연락처 메모', 'Local Emergency Contacts Memo', '기타', '예', '예', '제한 없음', 'manual'),
    ('여행자 보험 정보 소지', 'Travel Insurance Information', '기타', '예', '예', '제한 없음', 'manual'),
    ('도난방지용 가방', 'Anti-theft Bag', '기타', '예', '예', '제한 없음', 'manual'),
    ('복대 / 안전지갑', 'Money Belt/Security Wallet', '기타', '예', '예', '제한 없음', 'manual'),
    ('휴대용 경보기', 'Personal Alarm', '기타', '예 (특별 지침)', '예', '배터리 유형 확인이 필요합니다.', 'manual'),
    ('휴대용 도어락', 'Portable Door Lock', '기타', '예', '예', '제한 없음', 'manual');
    """
]
